...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            Weather_conditions =['Fog' ,'Stormy' ,'Cloudy' ,'Sandstorms' ,'Windy' ,'Sunny']
            Road_traffic_density = ['Low', 'Jam', 'Medium', 'High'] 
            ...
            cat_pipeline=Pipeline(
                ...
                ('ordinalencoder',OrdinalEncoder(categories=[Weather_conditions, Road_traffic_density,Type_of_order, Type_of_vehicle, Festival, City])),
                ('scaler',StandardScaler())
                ]
            )
